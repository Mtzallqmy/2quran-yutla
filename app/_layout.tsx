...
export default function RootLayout() { return <QuranThemeProvider><QuranContentProvider><PlayerProvider><Navigator /></PlayerProvider></QuranContentProvider></QuranThemeProvider>; }
