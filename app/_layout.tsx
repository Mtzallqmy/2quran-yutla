...
function Navigator() { const { colors, mode } = useQuranTheme(); return <View style={{ flex: 1, backgroundColor: colors.background }}><StatusBar style={mode === "dark" ? "light" : "dark"} /><Stack screenOptions={{ headerShown: false, animation: "fade" }}><Stack.Screen name="(tabs)" /><Stack.Screen name="player" options={{ presentation: "card" }} /><Stack.Screen name="admin/media" options={{ presentation: "card" }} /></Stack><MiniPlayer /></View>; }
